...
export default function BordGame() {
    return (
        <div className="border-secondary-500 flex h-[150px] w-[300px] items-center justify-between rounded-3xl border-8 sm:h-[300px] sm:w-[370px] md:h-[380px] md:w-[620px] lg:h-[500px] lg:w-[1000px] xl:h-[600px] xl:w-[1200px] animate-border">
